...
// TODO: Enhance input validation and error handling in the future
...
func main() {
	...
	for {
		...
		// * Validate user input
		var is_valid_name, is_valid_email, is_valid_ticket_count bool = validate_user_input(first_name, last_name, email, user_tickets)
